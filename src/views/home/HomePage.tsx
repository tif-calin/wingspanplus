    ...
    <>
      <Page>
        ...
        <section className="content">
          ...
          <p>
            Wingspan&apos;s base game comes with 170 birds along with a booster pack of 10 additional cards. The European expansion pack adds 81 new birds while Oceania expansion adds 95. Which makes a total of {DATA.length} bird cards. You can search through these cards using Navarog&apos;s beautiful site <ExternalLink href="https://navarog.github.io/wingsearch/">Wingsearch</ExternalLink>.
          </p>
          <p>
