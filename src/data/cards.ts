...
const data = [
  ...
  },
  {
      ...
      "rulings": [
          ...
          {
              "text": "When a bird with a <i>\"copy\"<\/i> power (e.g., the <strong applink=\"\/card\/349\">Superb Lyrebird<\/strong>) copies this bird's power, that bird retains the ability to spend [seed] cached on it until the end of the turn but no longer.",
  ...
  },
  {
      ...
      "rulings": [
          ...
          {
              "text": "When this bird repeats the power of a bird with a <i>\"copy\"<\/i> power (e.g., the <strong applink=\"\/card\/349\">Superb Lyrebird<\/strong>), this bird repeats the copying power printed on that bird and not any powers that bird copied earlier in the turn.",
  ...
  },
  {
      ...
      "rulings": [
          {
              "text": "This bird counts toward the <strong applink=\"\/card\/1007\">Cartographer<\/strong> bonus card. (In early printings that bonus card did list include the keyword <i>prairie<\/i>.)",
              "source": "https:\/\/www.stonemaiergames.com\/games\/wingspan\/rules\/"
          }
      ],
      "additionalRulings": [
